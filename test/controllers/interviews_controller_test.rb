...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference("Interview.count") do
      post interviews_url, params: { interview: { interviewee: @interview.interviewee, interviewers: @interview.interviewers, questionid: @interview.questionid, questionstatus: @interview.questionstatus } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { interviewee: @interview.interviewee, interviewers: @interview.interviewers, questionid: @interview.questionid, questionstatus: @interview.questionstatus } }
