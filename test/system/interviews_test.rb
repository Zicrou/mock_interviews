...
class InterviewsTest < ApplicationSystemTestCase
  ...
  test "should create interview" do
    ...
    fill_in "Interviewee", with: @interview.interviewee
    fill_in "Interviewers", with: @interview.interviewers
    fill_in "Questionid", with: @interview.questionid
    check "Questionstatus" if @interview.questionstatus
